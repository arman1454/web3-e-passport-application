// profileLabels.ts
// All label arrays for the profile page

export const personalInfoAllLabels = [
...
export const spouseInfoAllLabels = [
...
export const emergencyContactAllLabels = [
...
export const passportOptionsAllLabels = [
  { label:"Validity",key:"validity"},
  { label:"Passport Price",key:"price"},
];

export const deliveryAndAppointmentLabels = [
